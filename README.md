...
```
sudo apt install gcc-multilib g++-multilib  python python-pexpect libcapnp-dev capnproto autotools-dev autoconf gawk libpython-dev cmake zlib1g zlib1g-dev libdw-dev libbz2-1.0 libbz2-dev pkg-config liblzma-dev
